...
// Bind 绑定、解绑物流账号
// token 接口调用凭证
func (ea *ExpressAccount) Bind(token string) (*common.CommonError, error) {
	api := common.BaseURL + apiBindAccount
	return ea.bind(api, token)
}

func (ea *ExpressAccount) bind(api, token string) (*common.CommonError, error) {
	...
	if err := httpclient.PostJSON(url, ea, res); err != nil {
		return nil, err
	}
...
// token 接口调用凭证
func (e *Express) GetAllAccount(token string) (*AccountList, error) {
	api := common.BaseURL + apiGetAllAccount
...
func getAllAccount(api, token string) (*AccountList, error) {
	...
	res := new(AccountList)
	if err := httpclient.PostJSON(url, httpclient.RequestParams{}, res); err != nil {
		return nil, err
	}
...
func (ep *ExpressPathGetter) Get(token string) (*GetExpressPathResponse, error) {
	api := common.BaseURL + apiGetExpressPath
...
func (ep *ExpressPathGetter) get(api, token string) (*GetExpressPathResponse, error) {
	...
	if err := httpclient.PostJSON(url, ep, res); err != nil {
		return nil, err
	}
...
func (creator *ExpressOrderCreator) Create(token string) (*CreateExpressOrderResponse, error) {
	api := common.BaseURL + apiAddExpressOrder
...
// token 接口调用凭证
func (e *Express) GetAllDelivery(token string) (*DeliveryList, error) {
	api := common.BaseURL + apiGetAllDelivery
...
func (getter *ExpressOrderGetter) Get(token string) (*GetExpressOrderResponse, error) {
	api := common.BaseURL + apiGetExpressOrder
...
// Cancel 取消运单
// token 接 口调用凭证
func (canceler *ExpressOrderCanceler) Cancel(token string) (*common.CommonError, error) {
	api := common.BaseURL + apiCancelExpressOrder
	return canceler.cancel(api, token)
}

func (canceler *ExpressOrderCanceler) cancel(api, token string) (*common.CommonError, error) {
	url, err := httpclient.TokenAPI(api, token)
	if err != nil {
		return nil, err
	}
...
// token 接口调用凭证
func (e *Express) GetPrinter(token string) (*GetPrinterResponse, error) {
	api := common.BaseURL + apiGetPrinter
...
func (getter *QuotaGetter) Get(token string) (*QuotaGetResponse, error) {
	api := common.BaseURL + apiGetQuota
	return getter.get(api, token)
}
...
func (tester *UpdateExpressOrderTester) Test(token string) (*common.CommonError, error) {
	api := common.BaseURL + apiTestUpdateOrder
	return tester.test(api, token)
}

func (tester *UpdateExpressOrderTester) test(api, token string) (*common.CommonError, error) {
	url, err := httpclient.TokenAPI(api, token)
	if err != nil {
		return nil, err
	}
	...
	res := new(common.CommonError)
	if err := httpclient.PostJSON(url, tester, res); err != nil {
		return nil, err
	}
...
func (updater *PrinterUpdater) Update(token string) (*common.CommonError, error) {
	api := common.BaseURL + apiUpdatePrinter
	return updater.update(api, token)
}

func (updater *PrinterUpdater) update(api, token string) (*common.CommonError, error) {
	url, err := httpclient.TokenAPI(api, token)
	if err != nil {
		return nil, err
	}
