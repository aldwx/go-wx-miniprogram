...
func (d *DataAnalysis) GetMonthlyRetain(accessToken, begin, end string) (*RetainResponse, error) {
	api := common.BaseURL + apiGetMonthlyRetain
...
func (d *DataAnalysis) GetWeeklyRetain(accessToken, begin, end string) (*RetainResponse, error) {
	api := common.BaseURL + apiGetWeeklyRetain
	return getRetain(accessToken, begin, end, api)
}
...
func (d *DataAnalysis) GetDailyRetain(accessToken, begin, end string) (*RetainResponse, error) {
	api := common.BaseURL + apiGetDailyRetain
	return getRetain(accessToken, begin, end, api)
}
