...
func (d *DataAnalysis) GetMonthlyVisitTrend(accessToken, begin, end string) (*VisitTrend, error) {
	api := common.BaseURL + apiGetMonthlyVisitTrend
...
func (d *DataAnalysis) GetWeeklyVisitTrend(accessToken, begin, end string) (*VisitTrend, error) {
	api := common.BaseURL + apiGetWeeklyVisitTrend
	return getVisitTrend(accessToken, begin, end, api)
}
...
func (d *DataAnalysis) GetDailyVisitTrend(accessToken, begin, end string) (*VisitTrend, error) {
	api := common.BaseURL + apiGetDailyVisitTrend
	return getVisitTrend(accessToken, begin, end, api)
}
