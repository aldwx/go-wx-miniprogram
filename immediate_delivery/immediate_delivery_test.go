...
func TestAbnormalConfirm(t *testing.T) {
	...
	err := jsoniter.Unmarshal([]byte(raw), confirmer)
	if err != nil {
		t.Fatal(err)
	}
...
func TestAddDeliveryOrder(t *testing.T) {
	...
	err := jsoniter.Unmarshal([]byte(raw), creator)
	if err != nil {
		t.Fatal(err)
	}
...
func TestAddDeliveryTip(t *testing.T) {
	...
	err := jsoniter.Unmarshal([]byte(raw), adder)
	if err != nil {
		t.Fatal(err)
	}
...
func TestCancelDeliveryOrder(t *testing.T) {
	...
	err := jsoniter.Unmarshal([]byte(raw), canceler)
	if err != nil {
		t.Fatal(err)
	}
...
func TestGetDeliveryOrder(t *testing.T) {
	...
	err := jsoniter.Unmarshal([]byte(raw), getter)
	if err != nil {
		t.Fatal(err)
	}
...
func TestMockUpdateDeliveryOrder(t *testing.T) {
	...
	err := jsoniter.Unmarshal([]byte(raw), mocker)
	if err != nil {
		t.Fatal(err)
	}
...
func TestOnDeliveryOrderStatusUpdate(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		srv.OnDeliveryOrderStatusUpdate(func(mix *common.DeliveryOrderStatusUpdateResult) *common.DeliveryOrderStatusUpdateReturn {
			if mix.ToUserName == "" {
			...
			return &common.DeliveryOrderStatusUpdateReturn{
				"mock-to-user-name",
				"mock-from-user-name",
				20060102150405,
				"mock-message-type",
