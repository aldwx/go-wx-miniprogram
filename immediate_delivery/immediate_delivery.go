...
func (confirmer *AbnormalConfirmer) Confirm(token string) (*common.CommonResult, error) {
	api := common.BaseURL + apiAbnormalConfirm
	return confirmer.confirm(api, token)
}

func (confirmer *AbnormalConfirmer) confirm(api, token string) (*common.CommonResult, error) {
	url, err := httpclient.TokenAPI(api, token)
	if err != nil {
		return nil, err
	}

	res := new(common.CommonResult)
	if err := httpclient.PostJSON(url, confirmer, res); err != nil {
		return nil, err
	}
...
func (creator *DeliveryOrderCreator) Prepare(token string) (*PreDeliveryOrderResponse, error) {
	api := common.BaseURL + apiPreCancelDeliveryOrder
...
func (creator *DeliveryOrderCreator) prepare(api, token string) (*PreDeliveryOrderResponse, error) {
	...
	if err := httpclient.PostJSON(url, creator, res); err != nil {
		return nil, err
	}
...
func (creator *DeliveryOrderCreator) Create(token string) (*CreateDeliveryOrderResponse, error) {
	api := common.BaseURL + apiAddDeliveryOrder
...
func (creator *DeliveryOrderCreator) Recreate(token string) (*CreateDeliveryOrderResponse, error) {
	api := common.BaseURL + apiReAddDeliveryOrder
...
func (adder *DeliveryTipAdder) Add(token string) (*common.CommonResult, error) {
	api := common.BaseURL + apiAddDeliveryTip
	return adder.add(api, token)
}

func (adder *DeliveryTipAdder) add(api, token string) (*common.CommonResult, error) {
	url, err := httpclient.TokenAPI(api, token)
	if err != nil {
		return nil, err
	}
	...
	res := new(common.CommonResult)
	if err := httpclient.PostJSON(url, adder, res); err != nil {
		return nil, err
	}
...
func (canceler *DeliveryOrderCanceler) Prepare(token string) (*CancelDeliveryOrderResponse, error) {
	api := common.BaseURL + apiCancelDeliveryOrder
...
func (canceler *DeliveryOrderCanceler) prepare(api, token string) (*CancelDeliveryOrderResponse, error) {
	...
	if err := httpclient.PostJSON(url, canceler, res); err != nil {
		return nil, err
	}
...
func (i *ImmediateDelivery) GetAllImmediateDelivery(token string) (*GetAllImmediateDeliveryResponse, error) {
	api := common.BaseURL + apiGetAllImmediateDelivery
...
func (i *ImmediateDelivery) GetBindAccount(token string) (*GetBindAccountResponse, error) {
	api := common.BaseURL + apiGetDeliveryBindAccount
...
func (getter *DeliveryOrderGetter) Get(token string) (*GetDeliveryOrderResponse, error) {
	api := common.BaseURL + apiGetDeliveryOrder
...
func (getter *DeliveryOrderGetter) get(api, token string) (*GetDeliveryOrderResponse, error) {
	...
	if err := httpclient.PostJSON(url, getter, res); err != nil {
		return nil, err
	}
...
// Mock 模拟配送公司更新配送单状态
func (mocker *UpdateDeliveryOrderMocker) Mock(token string) (*common.CommonResult, error) {
	api := common.BaseURL + apiMockUpdateDeliveryOrder
	return mocker.mock(api, token)
}

func (mocker *UpdateDeliveryOrderMocker) mock(api, token string) (*common.CommonResult, error) {
	url, err := httpclient.TokenAPI(api, token)
	if err != nil {
		return nil, err
	}
	...
	res := new(common.CommonResult)
	if err := httpclient.PostJSON(url, mocker, res); err != nil {
		return nil, err
	}
...
func (updater *DeliveryOrderUpdater) Update(token string) (*common.CommonResult, error) {
	api := common.BaseURL + apiUpdateDeliveryOrder
	return updater.update(api, token)
}

func (updater *DeliveryOrderUpdater) update(api, token string) (*common.CommonResult, error) {
	url, err := httpclient.TokenAPI(api, token)
	if err != nil {
		return nil, err
	}
	...
	res := new(common.CommonResult)
	if err := httpclient.PostJSON(url, updater, res); err != nil {
		return nil, err
	}
