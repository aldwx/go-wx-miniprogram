...
func TestBankCard(t *testing.T) {
	...
	_, err := bankCard(ts.URL+apiBankcard, "mock-access-token", common.TestIMGName, RecognizeModePhoto)
	if err != nil {
		t.Fatal(err)
	}
	_, err = bankCard(ts.URL+apiBankcard, "mock-access-token", common.TestIMGName, RecognizeModeScan)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestDriverLicense(t *testing.T) {
	...
	_, err := driverLicense(ts.URL+apiDrivingLicense, "mock-access-token", common.TestIMGName)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestBusinessLicense(t *testing.T) {
	...
	_, err := businessLicense(ts.URL+apiBusinessLicense, "mock-access-token", common.TestIMGName)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestPrintedText(t *testing.T) {
	...
	_, err := printedText(ts.URL+apiPrintedText, "mock-access-token", common.TestIMGName)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestIDCard(t *testing.T) {
	...
	_, err := idCard(ts.URL+apiIDCard, "mock-access-token", common.TestIMGName, RecognizeModePhoto)
	if err != nil {
		t.Fatal(err)
	}
	_, err = idCard(ts.URL+apiIDCard, "mock-access-token", common.TestIMGName, RecognizeModeScan)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestVehicleLicense(t *testing.T) {
	...
	_, err := vehicleLicense(ts.URL+apiVehicleLicense, "mock-access-token", common.TestIMGName, RecognizeModePhoto)
	if err != nil {
		t.Fatal(err)
	}
	_, err = vehicleLicense(ts.URL+apiVehicleLicense, "mock-access-token", common.TestIMGName, RecognizeModeScan)
	if err != nil {
		t.Fatal(err)
	}
}
