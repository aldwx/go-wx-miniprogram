...
func (o *Ocr) BankCardByURL(token, cardURL string, mode RecognizeMode) (*BankCardResponse, error) {
	api := common.BaseURL + apiBankcard
...
// mode 图片识别模式，photo（拍照模式）或 scan（扫描模式）
func (o *Ocr) BankCard(token, filename string, mode RecognizeMode) (*BankCardResponse, error) {
	api := common.BaseURL + apiBankcard
...
// url 要检测的图片 url，传这个则不用传 img 参数。
// mode 图片识别模式，photo（拍照模式）或 scan（扫描模式）
func (o *Ocr) DriverLicenseByURL(token, licenseURL string) (*DrivingLicenseResponse, error) {
	api := common.BaseURL + apiDrivingLicense
...
// img form-data 中媒体文件标识，有filename、filelength、content-type等信息，传这个则不用传递 img_url。
// mode 图片识别模式，photo（拍照模式）或 scan（扫描模式）
func (o *Ocr) DriverLicense(token, filename string) (*DrivingLicenseResponse, error) {
	api := common.BaseURL + apiDrivingLicense
...
// url 要检测的图片 url，传这个则不用传 img 参数。
// mode 图片识别模式，photo（拍照模式）或 scan（扫描模式）
func (o *Ocr) IDCardByURL(token, cardURL string, mode RecognizeMode) (*IDCardResponse, error) {
	api := common.BaseURL + apiIDCard
...
// img form-data 中媒体文件标识，有filename、filelength、content-type等信息，传这个则不用传递 img_url。
// mode 图片识别模式，photo（拍照模式）或 scan（扫描模式）
func (o *Ocr) IDCard(token, filename string, mode RecognizeMode) (*IDCardResponse, error) {
	api := common.BaseURL + apiIDCard
...
func (o *Ocr) VehicleLicenseByURL(token, cardURL string, mode RecognizeMode) (*VehicleLicenseResponse, error) {
	api := common.BaseURL + apiVehicleLicense
...
func (o *Ocr) VehicleLicense(token, filename string, mode RecognizeMode) (*VehicleLicenseResponse, error) {
	api := common.BaseURL + apiVehicleLicense
...
func (o *Ocr) BusinessLicenseByURL(token, cardURL string) (*BusinessLicenseResponse, error) {
	api := common.BaseURL + apiBusinessLicense
...
func (o *Ocr) BusinessLicense(token, filename string) (*BusinessLicenseResponse, error) {
	api := common.BaseURL + apiBusinessLicense
...
func (o *Ocr) PrintedTextByURL(token, cardURL string) (*PrintedTextResponse, error) {
	api := common.BaseURL + apiPrintedText
...
func (o *Ocr) PrintedText(token, filename string) (*PrintedTextResponse, error) {
	api := common.BaseURL + apiPrintedText
...
func ocrByFile(api, token, filename string, mode RecognizeMode, response interface{}) error {
	...
	if err := httpclient.PostFormByFile(url, "img", filename, response); err != nil {
		return err
	}
...
func ocrByURL(api, token, cardURL string, mode RecognizeMode, response interface{}) error {
	...
	if err := httpclient.PostJSON(url, nil, response); err != nil {
		return err
	}
