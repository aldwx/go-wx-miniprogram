...
func TestUploadTempMedia(t *testing.T) {
	...
	_, err := uploadTempMedia("mock-access-token", "mock-media-type", common.TestIMGName, ts.URL+apiUploadTemplateMedia)
	if err != nil {
		t.Fatal(err)
	}
}
