...
func TestAICrop(t *testing.T) {
	...
	_, err := aiCrop(ts.URL+apiAICrop, "mock-access-token", common.TestIMGName)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestScanQRCode(t *testing.T) {
	...
	_, err := scanQRCode(ts.URL+apiScanQRCode, "mock-access-token", common.TestIMGName)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestSuperResolution(t *testing.T) {
	...
	_, err := superResolution(ts.URL+apiSuperResolution, "mock-access-token", common.TestIMGName)
	if err != nil {
		t.Fatal(err)
	}
}
